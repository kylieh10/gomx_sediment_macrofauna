...
You can also download the entire script here: [notebook_occurrence.R](scripts/notebook_occurrence.R)

::: callout-tip
## Portability

We used the `renv` package to make this script more portable. More information on this package and how it works can be found [here](https://rstudio.github.io/renv/articles/renv.html). 
:::
