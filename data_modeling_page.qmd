...
While a computer is not required here, it may be useful to have access to DwC vocabulary pages to reference in this process. This quick reference guide published by TDWG is a good starting point for mapping: <https://dwc.tdwg.org/terms/>. GBIF also has a vocabulary reference guide, sorted by DwC extension type: <https://rs.gbif.org/extensions.html>.
