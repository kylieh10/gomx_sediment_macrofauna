...
![Hand-drawn data visualization of relationships, Image by Kylie Hollis, License [CC0](https://creativecommons.org/publicdomain/zero/1.0/)](images/data_visualization.png){fig-alt="Schematic showing the relationships of different variables across three tables"}
